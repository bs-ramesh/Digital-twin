...
# # Add label_frame22 and elements inside
# label_frame22 = LabelFrame(label_frame12, text='Configurations', width=300, height=200)
# label_frame22.place(relx=0.6, rely=0.8, anchor='se')  # This places it in the bottom-right corner

# label_device_id = Label(label_frame22, text='Device ID:a'+abc)
# label_device_id.grid(row=0, column=0, padx=5, pady=5, sticky='w')
